...
# Load VECTOR_DB from a file if it exists
try:
    with open('vector_db.pkl', 'rb') as f:
        VECTOR_DB = pickle.load(f)
    print('Loaded VECTOR_DB from file')
except FileNotFoundError:
    print('VECTOR_DB file not found, creating a new one')
...
# Save VECTOR_DB to a file
with open('vector_db.pkl', 'wb') as f:
    pickle.dump(VECTOR_DB, f)
    print('Saved VECTOR_DB to file')
